            ...
            rows.append(
                {
                    ...
                    "parameters": summary.get("encoder_parameters", summary.get("parameters", "")),
                    "input_shape": summary.get("input_shape", ""),
                    "full_classifier_parameters": summary.get("full_classifier_parameters", ""),
