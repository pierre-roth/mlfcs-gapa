#!/bin/bash
#SBATCH --job-name=mlfcs-as-paper-seeds
...
RUN_ROOT="${RUN_ROOT:-/cluster/work/math/piroth/mlfcs-gapa/runs/extensions/as-paper-strengthening/${SLURM_ARRAY_JOB_ID:-manual}/extra-seeds}"
...
PYTHONUNBUFFERED=1 python -m mlfcs_gapa.extensions.as_paper_extra_seeds \
...
echo "extra-seed artifacts for task ${SLURM_ARRAY_TASK_ID:-0}:"
